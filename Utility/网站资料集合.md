...
+ Unreal
    ...
    + Lightmass
        + [UE5超详细的灯光烘焙教程_烘焙的规则（应该是李文磊的做的培训）](https://www.bilibili.com/video/BV12k4y1v7j8/?share_source=copy_web&vd_source=c6aca59e969bac551ef8777dcbc4b828)
        + [UE5光照烘焙-移动端的Lightmass](https://zhuanlan.zhihu.com/p/661677401)
        + [UE4中的Lightmass设置对比|灯光烘焙|全局光照（参数详解）](https://zhuanlan.zhihu.com/p/633729082?utm_id=0)
        + [【UE4_光照】UE4中光照的常见问题和解决方案(三)使用手册]（http://news.16p.com/878164.html）
+ OpenGL
...
+ Water
    ...
    + [UE4 动态液体材质浅谈](https://www.vraystation.com/news/on-ue4-dynamic-liquid-material/)
+ CDLOD
